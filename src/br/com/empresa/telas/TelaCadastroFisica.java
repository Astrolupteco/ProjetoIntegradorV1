 ...
 * @author josej
 */
public class TelaCadastroFisica extends javax.swing.JFrame {

    Connection conexao = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    public TelaCadastroFisica() {
    initComponents();
    conexao = ModuloDeConexao.conector();

    }
    private void adicionar() {
        String sql = "insert into tbusuarios(IDduser,usuario,telefone,login,senha,CPF,perfil,endereco) values(?,?,?,?,?,?,?,'Fornecedor')";
        try {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Cadastro primeiro acesso pessoa física");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroFisica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroFisica().setVisible(true);
            }
        });
    }
