...
public class TelaCadastroFornecedor extends javax.swing.JFrame {
    ...
    private void adicionar() {
        String sql = "insert into tbusuarios(IDduser,usuario,telefone,login,senha,CPF,perfil) values(?,?,?,?,?,?,'Fornecedor')";
        try {
            pst = conexao.prepareStatement(sql);
            
            
            pst.setString(1, FornecimentoField.getText());
            ...
            if (EmpresaField.getText().isEmpty() || (CpfField.getText().isEmpty()) || (LoginField.getText().isEmpty()) || (FornecimentoField.getText().isEmpty() || (SenhaField.getText().isEmpty()))) {
                ...
                if (adicionado > 0) {
                    ...
                    FornecimentoField.setText(null);
    ...
    private void initComponents() {
        ...
        FornecimentoField = new javax.swing.JTextField();
        ...
        jLabel6.setText("Cadastro primeiro acesso fornecedor");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(FornecimentoField)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel8)
                    .addComponent(FornecimentoField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private javax.swing.JTextField FornecimentoField;
